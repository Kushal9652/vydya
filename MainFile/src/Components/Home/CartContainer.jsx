...
export default function CartContainer() {
    const obj=[
        {
           icon:<i class="fa-brands text-[3rem] pl-[1rem] text-white pt-[1rem] fa-nutritionix"></i>,
           title:"Nutritions",
        ...
        {
           icon:<i class="fa-solid text-[3rem] pl-[1rem] text-white pt-[1rem] fa-droplet"></i>,
       ...
       ,
        {
           icon:<i class="fa-solid text-[3rem] pl-[1rem] text-white pt-[1rem] fa-truck-fast"></i>,
       ...
       ,
        {
           icon:<i class="fa-solid text-[3rem] pl-[1rem] text-white pt-[1rem] fa-calendar-check"></i>,
